...
const API =
  ...
  "https://forever-pos.onrender.com";
      ...
      <div className="container">
        ...
        {tab === "manage" && isAdmin && (
          <section className="manage-grid no-print">
            ...
            <div className="card manage-wide">
              <SectionTitle icon={<Users size={18} />} title="Danh sách tài khoản" />
              <div className="stack">
                {users.map((u) => (
                  <div key={u.id} className="manage-row">
                    <div>
                      ...
                      <div className="muted small">
                        {u.username} • {u.role === "admin" ? "Quản lý" : "Thu ngân"}
                      </div>
                    </div>
                    <div className="row-actions">
                      <button
